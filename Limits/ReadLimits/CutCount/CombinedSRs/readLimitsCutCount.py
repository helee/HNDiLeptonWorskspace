...
for _iter in range(0,niter):
       ...
       for _id in IDs:
              ...
              for mass in _masses:
                     ...
                     scale    = GetScale(mass)
                     nSignal1 = GetSignalCountSRMass(year, Analyzer, isVBF, "Central", flavour, "SR1", mass, _id)
                     nSignal2 = GetSignalCountSRMass(year, Analyzer, isVBF, "Central", flavour, "SR2", mass, _id)
                     ...
                     outfile.write(mass + "\t" + str(scale) + "\t" + str(nSignal1) + "\t" + str(nSignal2) + "\t" + str(rValue0) + "\t" + str(rValue1) + "\t" + str(rValue2) + "\t" + str(rValue3) + "\t" + str(rValue4) + "\n")
              ...
              outfile.close()
                     ...
                     #3card_2017_EE_SR1_N1500_passTightID_nocc_reco_mlljj.txt"
                     ##card_2018_MuMu_SR1_N700_combined_POGTightPFIsoVeryTight.txt
                     ##higgsCombinecard_2016_EE_combined_SR1_SR2_N1000_VBF_passTightID.txt_exp0.500.HybridNew.mH120.quant0.500.root
